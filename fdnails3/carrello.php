...
if (is_file(__DIR__ . "/php/promozioni.php")) require_once __DIR__ . "/php/promozioni.php";
      ...
      <table cellpadding="10" cellspacing="0" style="width:100%; border-collapse:collapse;">
            ...
            <td style="border-bottom:1px solid #f0f0f0;">
              <?php if ($r["perc"] > 0): ?>
                <span style="text-decoration:line-through; color:#777;">
                  <?= number_format((float)$r["p"]["prezzo"], 2, ",", ".") ?> €
                </span><br>
                <b><?= number_format((float)$r["prezzo_s"], 2, ",", ".") ?> €</b>
                <span style="color:#777;">(-<?= (int)$r["perc"] ?>%)</span>
              <?php else: ?>
                <?= number_format((float)$r["p"]["prezzo"], 2, ",", ".") ?> €
              <?php endif; ?>
            </td>
            <td style="border-bottom:1px solid #f0f0f0;"><?= number_format((float)$r["sub"], 2, ",", ".") ?> €</td>
        ...
        <?php if ($totale_sconto > 0.0001): ?>
          <tr>
            ...
            <td colspan="2" style="padding-top:14px; border-top:1px solid #eee;"><?= number_format((float)$totale_listino, 2, ",", ".") ?> €</td>
          </tr>
          <tr>
            <td colspan="3" style="text-align:right;">Sconto</td>
            <td colspan="2">-<?= number_format((float)$totale_sconto, 2, ",", ".") ?> €</td>
          </tr>
        <?php endif; ?>

        <tr>
          <td colspan="3" style="text-align:right; padding-top:14px; border-top:1px solid #eee;"><b>Totale</b></td>
          <td colspan="2" style="padding-top:14px; border-top:1px solid #eee;"><b><?= number_format((float)$totale, 2, ",", ".") ?> €</b></td>
        </tr>
      </table>
    </div>
